...
/**
 * A LinearLayoutManager that sets the size of the Recyclerview to match all of the views inside of the
 * recyclerview
 */
final class NestedLinearLayoutManager extends LinearLayoutManager {
    ...
    private void measureChild(RecyclerView.Recycler recycler, int position, int widthSize, int heightSize, int[] dimensions) {
        ...
        try {
            ...
            Log.w(TAG, "Doesn't work well with animations. Consider switching them off", e);
            return;
        }
